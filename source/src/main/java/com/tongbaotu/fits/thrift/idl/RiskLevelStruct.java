...
public class RiskLevelStruct implements org.apache.thrift.TBase<RiskLevelStruct, RiskLevelStruct._Fields>, java.io.Serializable, Cloneable, Comparable<RiskLevelStruct> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RiskLevelStruct");
  ...
  static {
    schemes.put(StandardScheme.class, new RiskLevelStructStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RiskLevelStructTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RiskLevelStruct.class, metaDataMap);
  }

  public RiskLevelStruct() {
  }
   ...
   */
  public RiskLevelStruct(RiskLevelStruct other) {
  ...
  public RiskLevelStruct deepCopy() {
    return new RiskLevelStruct(this);
  }
  ...
  public RiskLevelStruct setInvestorID(String investorID) {
    this.investorID = investorID;
    return this;
  }
  ...
  public RiskLevelStruct setRiskLevel(int riskLevel) {
    this.riskLevel = riskLevel;
    setRiskLevelIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RiskLevelStruct)
      return this.equals((RiskLevelStruct)that);
    return false;
  }

  public boolean equals(RiskLevelStruct that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(RiskLevelStruct other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RiskLevelStruct(");
    boolean first = true;
  ...
  private static class RiskLevelStructStandardSchemeFactory implements SchemeFactory {
    public RiskLevelStructStandardScheme getScheme() {
      return new RiskLevelStructStandardScheme();
    }
  }

  private static class RiskLevelStructStandardScheme extends StandardScheme<RiskLevelStruct> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RiskLevelStruct struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RiskLevelStruct struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RiskLevelStructTupleSchemeFactory implements SchemeFactory {
    public RiskLevelStructTupleScheme getScheme() {
      return new RiskLevelStructTupleScheme();
    }
  }

  private static class RiskLevelStructTupleScheme extends TupleScheme<RiskLevelStruct> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RiskLevelStruct struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RiskLevelStruct struct) throws org.apache.thrift.TException {
